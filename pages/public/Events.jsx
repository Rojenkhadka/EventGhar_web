...
const Events = () => {
  ...
  // Event images cycling through available images
  const eventsImages = [eventImg1, eventImg2, eventImg3];
  ...
  useEffect(() => {
    const slideInterval = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % eventsImages.length);
  ...
  // Generate event data with locations matching the design
  const popularEvents = [
    { id: 1, name: 'LOREM IPSUM RESORT', location: 'ABU DHABI', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[0] },
    { id: 2, name: 'LOREM IPSUM RESORT', location: 'LONDON', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[1] },
    { id: 3, name: 'LOREM IPSUM RESORT', location: 'TOKYO', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[2] },
    { id: 4, name: 'LOREM IPSUM RESORT', location: 'THAILAND', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[0] },
    { id: 5, name: 'LOREM IPSUM RESORT', location: 'SINGAPORE', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[1] },
    { id: 6, name: 'LOREM IPSUM RESORT', location: 'BANGKOK', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[2] },
    { id: 7, name: 'LOREM IPSUM RESORT', location: 'ABU DHABI', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[0] },
    { id: 8, name: 'LOREM IPSUM RESORT', location: 'LONDON', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[1] },
    { id: 9, name: 'LOREM IPSUM RESORT', location: 'TOKYO', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[2] },
    { id: 10, name: 'LOREM IPSUM RESORT', location: 'THAILAND', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[0] },
    { id: 11, name: 'LOREM IPSUM RESORT', location: 'SINGAPORE', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[1] },
    { id: 12, name: 'LOREM IPSUM RESORT', location: 'BANGKOK', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[2] },
  ];

  const recommendedEvents = [
    { id: 1, name: 'LOREM IPSUM RESORT', location: 'ABU DHABI', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[0] },
    { id: 2, name: 'LOREM IPSUM RESORT', location: 'ABU DHABI', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[1] },
    { id: 3, name: 'LOREM IPSUM RESORT', location: 'ABU DHABI', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[2] },
    { id: 4, name: 'LOREM IPSUM RESORT', location: 'ABU DHABI', rating: 5, reviews: 22, capacity: 'Upto 500 Guests', image: eventsImages[0] },
  ];
        ...
        <div className="landing-container">
          <div className="landing-navbar">
            ...
            <nav className="landing-nav">
              ...
              <a href="/events" className="active" onClick={(e) => { e.preventDefault(); navigate('/events'); }}>Events</a>
              ...
              onMouseLeave={(e) => {
                ...
                <div style={{ padding: '20px' }}>
                  <h3 style={{
                    ...
                    {event.name}, <span style={{ fontWeight: '700' }}>{event.location}</span>
                  </h3>
                  <div style={{
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    <span style={{
                      ...
                      fontSize: '14px',
                      letterSpacing: '2px'
                    }}>{renderStars(event.rating)}</span>
                    <span style={{
                      fontSize: '13px',
                      color: '#1a1a1a',
                      fontWeight: '600'
                    }}>{event.rating} ({event.reviews})</span>
                  </div>
                  <p style={{
                    fontSize: '13px',
                    color: '#666666',
          ...
          <div style={{
            ...
            <div>
              <h2 style={{
                ...
                marginBottom: '24px',
                lineHeight: '1.2'
              }}>Perfect Event, Memorable Events.</h2>
              <p style={{
                fontSize: '18px',
      ...
      <footer className="landing-footer">
        <div className="landing-container">
          <div className="landing-footerContent">
            ...
            {/* Events Links */}
            <div className="landing-footerColumn">
              <h4 className="landing-footerTitle">Events</h4>
